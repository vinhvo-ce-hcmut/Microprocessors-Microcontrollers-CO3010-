...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Lab 01 - Exercise 10 (analog clock: hour, minute, second hands)
  *
  * Wiring:
...
static uint8_t clockHour = 10U;
static uint8_t clockMinute = 10U;
static uint8_t clockSecond = 30U;
...
static void runExercise10(void);
...
{
  clearAllClock();
  setNumberOnClock((int)(clockHour % 12U));
  setNumberOnClock((int)(clockMinute / 5U));
  setNumberOnClock((int)(clockSecond / 5U));
  HAL_Delay(1000U);
  ...
  if (clockSecond >= 60U)
  {
    ...
    {
      clockMinute = 0U;
      clockHour = (uint8_t)((clockHour + 1U) % 12U);
    }
  }
}
